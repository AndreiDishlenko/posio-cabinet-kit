...
{
    /**
     * CabinetKit stores small per-user preferences (current_account, menu_groups,
     ...
     * rename it in config/cabinet-kit.php (`user_settings_column`) instead of
     * running this migration.
     */
    public function up(): void
    {
        $table = config('cabinet-kit.users_table', 'users');
        $column = config('cabinet-kit.user_settings_column', 'settings');
