...
<style lang="scss">
	...
	// Знак стрелки в иконке сидит ниже центра рамки (~5% высоты), и поворот при
	// сворачивании уводил его вверх: у открытой и закрытой группы стрелки стояли на
	// разной высоте. Центрируем знак, чтобы он вращался вокруг своей оси.
	.acc-arrow svg {
