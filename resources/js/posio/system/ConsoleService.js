...
// Строки ПРРО содержат JSON, и обрезка до пары сотен символов оставляла в базе
// огрызок, по которому ничего не восстановить. Колонка сообщения переведена в
// text; предел здесь стоит только против аномально длинной записи, которая
// раздула бы вставку всей пачки.
