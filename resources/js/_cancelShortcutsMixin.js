...
export default {
	...
	methods: {
		...
		onCancelBackButton() {
			...
			// Открытый диалог подтверждения снимает возврат сам, своей записью
			// в истории; проверка страхует промежуток, пока он гаснет — второй
			// диалог поверх первого открывать не нужно.
